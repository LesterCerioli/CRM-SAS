      ...
      <S.NavBar className="fixed">
        ...
        <S.MajorLinksContainer>
          <S.LinksContainer className={isMenuOpen ? "show-links" : ""}>
            ...
            <S.Link href="/appointment/medicalAppointment">Marcação de Comsultas</S.Link>
            <S.Link href="/appointment/cancelAppointment">Cancelamentos</S.Link>
            <S.Link href="/appointment/filters">Filtros</S.Link>
            {isMenuOpen && (
